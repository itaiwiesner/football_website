<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="registration.aspx.cs" Inherits="UpdatedFinalProject.registration" %>
    ...
    <link rel="stylesheet" type="text/css" href="css2.css" media="screen" />
     <script>
                        function chkForm()
                        {
                            ...
                            // בדיקה ששם המשתמש לא קצר מידי, ארוך, או לא קיים
                            if (userName.length < 2 || userName.length > 15)
                            {
                                document.getElementById("mUserName").value = "על שדה שם משתמש להכיל 2-15 תווים";
    ...
    <h1>טופס הרשמה</h1>
        <table>
            <tr>
                ...
                <td>
                    <input type="text" id="mUserName" size="30"
